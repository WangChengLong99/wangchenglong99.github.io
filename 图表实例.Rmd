...
```{python import-data,results="asis"}
import pandas as pd
import numpy as np
...
```{r plot-flow,echo=FALSE}
knitr::include_graphics("static/image/可视化/绘制流程.jpg")
```
...
```{r ticks-format,echo=FALSE}
knitr::include_graphics("static/image/可视化/format.png")
```
...
```{r adjust-plot,echo=FALSE}
knitr::include_graphics("static/image/可视化/adjust.png")
```
...
```{r legend-png,echo=FALSE}
knitr::include_graphics("static/image/可视化/legend.png")
```
...
```{r include-box,echo=FALSE}
knitr::include_graphics("static/image/可视化/箱线图.png")
```
