...
```{python importmodule,include=FALSE}
import pandas as pd
import numpy as np
import os
```
...
```{r readcsv,echo=FALSE,fig.caption="python读取csv"}
knitr::include_graphics("static/image/数据/python读取csv文件.png")
```
...
```{python csvChunksize,results="asis"}
