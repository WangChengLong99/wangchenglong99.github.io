...
| 11 | .second        | 30                                                                       |
| 12 | .strftime      | <built-in method strftime of datetime.time object at 0x0000028DB113D290> |
| 13 | .tzinfo        |                                                                          |
| 14 | .tzname        |                                                                          |
| 15 | .utcoffset     |                                                                          |
...
|    | 方法或属性        | 实例                                                                                                                       | 方法或属性       | 实例                                                                   |
|----|-------------------|----------------------------------------------------------------------------------------------------------------------------|------------------|------------------------------------------------------------------------|
|  0 | .now              | 2024-04-28 23:49:21.044233                                                                                                 | .astimezone      | 2021-11-26 16:00:00+08:00                                              |
...
|  4 | .strftime         | <built-in method strftime of datetime.datetime object at 0x0000028DAF3FD740>                                               | .day             | 26                                                                     |
...
| 10 | .today            | 2024-04-28 23:49:21.044233                                                                                                 | .fromtimestamp   | <built-in method fromtimestamp of type object at 0x00007FFE0F489330>   |
...
| 15 | .utcnow           | 2024-04-28 15:49:21.044233                                                                                                 | .max             | 9999-12-31 23:59:59.999999                                             |
...
```scroll-200
datetime.datetime(2024, 4, 28, 23, 49, 21, 511270)
```
...
```scroll-200
datetime.datetime(2024, 4, 28, 23, 49, 21, 511270, tzinfo=datetime.timezone(datetime.timedelta(seconds=28800)))
```
...
```scroll-200
datetime.timedelta(days=877, seconds=29161, microseconds=614994)
```
...
```scroll-200
Timestamp('2024-04-30 23:49:21.802160')
```
...
```scroll-200
Timestamp('2024-02-29 23:49:21.802160')
```
...
```scroll-200
2012-03-09 04:30:00-05:00   -1.192618
2012-03-10 04:30:00-05:00    1.576665
2012-03-11 05:30:00-04:00   -1.252044
2012-03-12 05:30:00-04:00   -0.130145
2012-03-13 05:30:00-04:00    0.091672
2012-03-14 05:30:00-04:00   -1.052478
...
2023-01-01          NaN
2023-01-02          NaN
2023-01-03    37.666667
2023-01-04    49.500000
2023-01-05    49.200000
                ...    
2023-03-27    52.500000
2023-03-28    49.300000
2023-03-29    45.300000
2023-03-30    46.700000
2023-03-31    46.200000
Freq: D, Length: 90, dtype: float64
```
...
```scroll-200
2023-01-01    48.666667
2023-01-02    50.571429
2023-01-03    45.750000
2023-01-04    42.444444
2023-01-05    45.000000
                ...    
2023-03-27    41.666667
2023-03-28    43.000000
2023-03-29    39.428571
2023-03-30    36.000000
2023-03-31    41.600000
Freq: D, Length: 90, dtype: float64
```
