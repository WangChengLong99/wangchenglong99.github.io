...
|  0 | .dst           |                                                                          |
|  1 | .fold          | 0                                                                        |
|  2 | .fromisoformat | <built-in method fromisoformat of type object at 0x00007FFB96D2D4B0>     |
|  3 | .hour          | 15                                                                       |
...
| 11 | .second        | 30                                                                       |
| 12 | .strftime      | <built-in method strftime of datetime.time object at 0x0000019138FA3990> |
| 13 | .tzinfo        |                                                                          |
| 14 | .tzname        |                                                                          |
| 15 | .utcoffset     |                                                                          |
...
|    | 方法或属性        | 实例                                                                                                                       | 方法或属性       | 实例                                                                   |
|----|-------------------|----------------------------------------------------------------------------------------------------------------------------|------------------|------------------------------------------------------------------------|
|  0 | .now              | 2023-03-24 16:58:57.992220                                                                                                 | .astimezone      | 2021-11-26 16:00:00+08:00                                              |
|  1 | .replace          | 2021-11-26 16:00:00                                                                                                        | .combine         | <built-in method combine of type object at 0x00007FFB96D2D650>         |
|  2 | .resolution       | 0:00:00.000001                                                                                                             | .ctime           | Fri Nov 26 16:00:00 2021                                               |
|  3 | .second           | 0                                                                                                                          | .date            | 2021-11-26                                                             |
|  4 | .strftime         | <built-in method strftime of datetime.datetime object at 0x0000019139334330>                                               | .day             | 26                                                                     |
|  5 | .strptime         | <built-in method strptime of type object at 0x00007FFB96D2D650>                                                            | .dst             |                                                                        |
|  6 | .time             | 16:00:00                                                                                                                   | .fold            | 0                                                                      |
|  7 | .timestamp        | 1637913600.0                                                                                                               | .fromisocalendar | <built-in method fromisocalendar of type object at 0x00007FFB96D2D650> |
|  8 | .timetuple        | time.struct_time(tm_year=2021, tm_mon=11, tm_mday=26, tm_hour=16, tm_min=0, tm_sec=0, tm_wday=4, tm_yday=330, tm_isdst=-1) | .fromisoformat   | <built-in method fromisoformat of type object at 0x00007FFB96D2D650>   |
|  9 | .timetz           | 16:00:00                                                                                                                   | .fromordinal     | <built-in method fromordinal of type object at 0x00007FFB96D2D650>     |
| 10 | .today            | 2023-03-24 16:58:57.992221                                                                                                 | .fromtimestamp   | <built-in method fromtimestamp of type object at 0x00007FFB96D2D650>   |
...
| 14 | .utcfromtimestamp | <built-in method utcfromtimestamp of type object at 0x00007FFB96D2D650>                                                    | .isoweekday      | 5                                                                      |
| 15 | .utcnow           | 2023-03-24 08:58:57.992220                                                                                                 | .max             | 9999-12-31 23:59:59.999999                                             |
...
```{.scroll-200}
datetime.datetime(2023, 3, 24, 16, 58, 59, 389527)
```
...
```{.scroll-200}
datetime.datetime(2023, 3, 24, 16, 58, 59, 389527, tzinfo=datetime.timezone(datetime.timedelta(seconds=28800)))
```
...
```{.scroll-200}
datetime.timedelta(days=476, seconds=4539, microseconds=796571)
```
...
```{.scroll-200}
Timestamp('2023-03-31 16:59:00.644662')
```
...
```{.scroll-200}
Timestamp('2023-01-31 16:59:00.644662')
```
...
```{.scroll-200}
2012-03-09 04:30:00-05:00    0.597419
2012-03-10 04:30:00-05:00    1.251994
2012-03-11 05:30:00-04:00   -0.264553
2012-03-12 05:30:00-04:00   -0.017677
2012-03-13 05:30:00-04:00   -0.787714
2012-03-14 05:30:00-04:00   -0.517989
...
2023-01-01          NaN
2023-01-02          NaN
2023-01-03    39.666667
2023-01-04    41.500000
2023-01-05    34.800000
                ...    
2023-03-27    71.400000
2023-03-28    68.200000
2023-03-29    64.800000
2023-03-30    63.100000
2023-03-31    68.900000
Freq: D, Length: 90, dtype: float64
```
...
```{.scroll-200}
2023-01-01    41.666667
2023-01-02    45.285714
2023-01-03    42.375000
2023-01-04    44.111111
2023-01-05    42.400000
                ...    
2023-03-27    67.333333
2023-03-28    64.500000
2023-03-29    62.285714
2023-03-30    57.833333
2023-03-31    61.400000
Freq: D, Length: 90, dtype: float64
```
