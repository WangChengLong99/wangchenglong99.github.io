...
knitr::include_graphics("https://matplotlib.org/_images/anatomy.png")
```
...
```{r bar_label,echo=FALSE}
knitr::include_graphics("https://img-blog.csdnimg.cn/99bc6e007eb34fc09015589d56c6eafc.png")
```
...
```{r color-name-png,echo=FALSE}
knitr::include_graphics( "https://matplotlib.org/3.1.0/_images/sphx_glr_named_colors_002.png")
```

```{r color-name-png-2,echo=FALSE}
knitr::include_graphics( "https://matplotlib.org/3.1.0/_images/sphx_glr_named_colors_003.png")
```
